                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ '/products/update' }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="text" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $product->getPriceFormatted() }}" required autocomplete="price" autofocus>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('type_id') is-invalid @enderror" aria-label="Default select example" name="type_id" >
                                        @foreach($types as $key => $val)
                                            <option {{ ($product->type_id == $key) ? 'selected=selected' : null }} value="{{ $key }}">{{ $val }}</option>
                                        @endforeach
